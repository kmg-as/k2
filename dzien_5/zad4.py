#klasa Basket, umozliwiająca ddawanie produktów w okreslonej liczbie do koszyka
#metoda obliczająca całkowita wartośc koszyka oraz wypisujaca info o zaw. koszyka
#podwójne dodanie tego samego produktu daje jeden produkt w koszyku
...
class Basket:
    ...
    def generate_report(self):
        ...
        for be in self.products:
            report +='-{be.product.name} ({be.product.id}), cena: {be.product.prices:.2f} x '
        report +="W sumie: {self.count_total_price():.2f}"
        return report
